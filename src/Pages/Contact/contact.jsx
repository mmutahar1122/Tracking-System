...
const Contact=()=>{
  ...
  const [contactUser, setContactUser]=useState(initialdata);
...
console.log(contactUser)
    ...
    return <>
    <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-red-700 rounded-lg">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        <div>
          ...
          <p className="text-sm text-white mt-6 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
          ...
          <ul className="mt-12 space-y-8">
            ...
            <li className="flex items-center">
              ...
              <a href="javascript:void(0)" className="text-white text-sm ml-4">
                Islamia College Sargodha Road Faislabad
              </a>
            </li>
          </ul>
          ...
          <ul className="flex mt-12 space-x-4">
            <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#b91c1c'
                  viewBox="0 0 24 24">
                  <path
        ...
        <div className="bg-gray-200 p-6 rounded-lg">
          ...
          {/* <div className="flex items-center flex-wrap gap-4 mt-4">
            <button type="button" className="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-0 cursor-pointer border-2 border-[#a91079]">Web design</button>
            <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-slate-900 text-sm tracking-wider font-medium outline-0 cursor-pointer border-2 border-gray-300">Graphic design</button>
            <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-slate-900 text-sm tracking-wider font-medium outline-0 cursor-pointer border-2 border-gray-300">Design system</button>
          </div> */}
          ...
          <form className="mt-8 space-y-4">
            ...
            <textarea placeholder='Message' rows="6"
              ...
              name="message"
              onChange={handleChange}
              value={contactUser.message}></textarea>
            
            <button type='button'
              className="text-white bg-red-700 tracking-wide rounded-lg text-sm font-medium px-4 py-3 flex items-center justify-center w-full cursor-pointer !mt-2"
