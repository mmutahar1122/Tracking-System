...
const handleSubmit = (e) => {
  ...
  // Step 2: Push the new user into the array
  existingUsers.push(user); // assuming `user` is a valid object

  // Step 3: Save the updated users array back to localStorage
